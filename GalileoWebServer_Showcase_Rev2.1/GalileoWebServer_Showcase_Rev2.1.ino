...
void setup() {
  ...
  for(int i = 0; i < 4; i++)  pinMode(relayPin[i],OUTPUT); // Set relay pins to output
...
void loop() {
  ...
  if (client) {
    ...
    // control arduino pin manually
    manualControls(currentTime);
